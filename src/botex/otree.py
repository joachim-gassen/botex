...
def init_otree_session(
    ...
    bot_urls = [urls[i] for i in sample(range(npart), npart - nhumans)]
    human_urls = list(set(urls) - set(bot_urls))
    ...
    return {
        ...
        'bot_urls': bot_urls, 'human_urls': human_urls
    }
